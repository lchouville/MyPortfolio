...
const populateProjects = (projectsData) => {
    if (!projectsGrid) {
      console.error("L'élément .projects-grid n'a pas été trouvé dans #projets-tab.");
      return;
    }
    ...
    projectsData.forEach(project => {
      ...
      description.textContent = project.description || 'Description du projet non disponible.';
